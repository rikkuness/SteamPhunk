...
public class TerrainLoader : MonoBehaviour {
    ...
    void Start() {
        worldTiles.Add(new TerrainTile(225, 131, 8,0,1));
        worldTiles.Add(new TerrainTile(225, 132, 8,0,0));
        worldTiles.Add(new TerrainTile(226, 131, 8,1,1));
        worldTiles.Add(new TerrainTile(226, 132, 8,1,0));
    ...
    IEnumerator loadTerrainTile(TerrainTile tile)
    {
        ...
        tile.url = baseUrl + tile.z + "/" + tile.x + "/" + tile.y + ".png?access_token=" + accessToken;
        ...
        float[,] terrainHeights = terrainData.GetHeights(0, 0, tileSize, tileSize);
